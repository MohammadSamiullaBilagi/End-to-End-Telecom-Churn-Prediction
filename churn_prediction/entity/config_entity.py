...
class DataIngestionConfig:
    def __init__(self, training_pipeline_config: TrainingPipelineConfig):
        ...
        # directory for feature store (under data_ingestion)
    ...
    # include DATA_INGESTION_DIR_NAME so feature_store_file is under data_ingestion/feature_store
...
class ModelTrainerConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.overfitting_underfitting_threshold:float=training_pipeline.MODEL_TRAINER_OVER_FITTING_UNDER_FITIING_THRESHOLD
